...
const Feature = () => {        
    ...
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="text-center">
            ...
            <p className="mt-4 text-base leading-7 text-gray-600 sm:mt-8 font-pj">Bridging Communication Gaps, Instantly and Effortlessly</p>
        </div>
        ...
        <div className="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-3 md:gap-0 xl:mt-24">
            <div className="md:p-8 lg:p-14">
                ...
                <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Instant Text Translation</h3>
                <p className="mt-5 text-base text-gray-600 font-pj">Supports multiple languages for quick, accurate translations</p>
            </div>
            ...
            <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
                ...
                <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Text-to-Speech</h3>
                <p className="mt-5 text-base text-gray-600 font-pj">Choose from various languages and accents for a personalized experience.</p>
            </div>
            ...
            <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
                ...
                <p className="mt-5 text-base text-gray-600 font-pj">Transforms speech into text with precision.</p>
            </div>
            ...
            <div className="md:p-8 lg:p-14 md:border-t md:border-gray-200">
                ...
                <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">User-Friendly Interface</h3>
                <p className="mt-5 text-base text-gray-600 font-pj">Navigate easily with a clean, accessible UI</p>
            </div>
            ...
            <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
                ...
                <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Data Privacy and Security</h3>
                <p className="mt-5 text-base text-gray-600 font-pj">All communications are encrypted, ensuring user data stays private</p>
            </div>
            ...
            <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
                ...
                <p className="mt-5 text-base text-gray-600 font-pj">Delivers quick translations and transcriptions, minimizing waiting time and enhancing user experience.</p>
            </div>
        </div>
    </div>
</section>
